...
Good:
- I liked that the whole task was divided into four smaller parts.
- I liked that we recieved the tasks through MQTT, it was a practical example and kept up the pace.

Difficult:
- This time there wasn't anything difficult.

Fun exploration / struggling:
- A few times we couldn't find a certain thing in the LuCI interface or were confused about a step, but we figured it out eventually.
